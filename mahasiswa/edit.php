                ...
                <tr>
                  ...
                  <td>
                    <select class="form-control" name="prodi" id="prodi" required>
                      <option value="D3 Teknik Informatika" <?php if ($row['program_studi'] == "D3 Teknik Informatika") {
                                                            echo "selected";
                                                          } ?>>D3 Teknik Informatika</option>
                      <option value="D3 Manajemen Informatika" <?php if ($row['program_studi'] == "D3 Manajemen Informatika") {
                                                          echo "selected";
                                                        } ?>>D3 Manajemen Informatika</option>
                      <option value="S1 Informatika" <?php if ($row['program_studi'] == "S1 Informatika") {
                                                            echo "selected";
                                                          } ?>>S1 Informatika</option>
                      <option value="S1 Sistem Informasi" <?php if ($row['program_studi'] == "S1 Sistem Informasi") {
                                                          echo "selected";
